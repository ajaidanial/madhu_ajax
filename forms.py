...
class Form1Form(Form):
    ...
    actual_2 = StringField("actual_1", validators=[DataRequired()])
    actual_3 = StringField("actual_1", validators=[DataRequired()])
    actual_4 = StringField("actual_1", validators=[DataRequired()])
    actual_5 = StringField("actual_1", validators=[DataRequired()])
    actual_6 = StringField("actual_1", validators=[DataRequired()])
    actual_7 = StringField("actual_1", validators=[DataRequired()])
    actual_8 = StringField("actual_1", validators=[DataRequired()])
    actual_total = StringField("actual_1", validators=[DataRequired()])
